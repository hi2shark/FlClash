...
@freezed
abstract class UnlockTestItem with _$UnlockTestItem {
  const factory UnlockTestItem({
    required String id,
    required String url,
    String? method,
    @JsonKey(name: 'region-regex') String? regionRegex,
    @JsonKey(name: 'expected-status') List<int>? expectedStatus,
  }) = _UnlockTestItem;

  factory UnlockTestItem.fromJson(Map<String, Object?> json) =>
      _$UnlockTestItemFromJson(json);
}

@freezed
abstract class UnlockTestParams with _$UnlockTestParams {
  const factory UnlockTestParams({
    @JsonKey(name: 'proxy-name') required String proxyName,
    int? timeout,
    @Default([]) List<UnlockTestItem> tests,
  }) = _UnlockTestParams;

  factory UnlockTestParams.fromJson(Map<String, Object?> json) =>
      _$UnlockTestParamsFromJson(json);
}

@freezed
abstract class UnlockTestResultItem with _$UnlockTestResultItem {
  const factory UnlockTestResultItem({
    @Default('') String id,
  ...
  factory UnlockTestResultItem.fromJson(Map<String, Object?> json) =>
      _$UnlockTestResultItemFromJson(json);
}

@freezed
abstract class UnlockTestResult with _$UnlockTestResult {
  const factory UnlockTestResult({
    @Default('') String name,
    @Default([]) List<UnlockTestResultItem> results,
    @Default('') String error,
  }) = _UnlockTestResult;

  factory UnlockTestResult.fromJson(Map<String, Object?> json) =>
      _$UnlockTestResultFromJson(json);
}
