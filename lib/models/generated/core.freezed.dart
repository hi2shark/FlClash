...
/// @nodoc
mixin _$UnlockTestItem {

 String get id; String get url; String? get method;@JsonKey(name: 'region-regex') String? get regionRegex;@JsonKey(name: 'expected-status') List<int>? get expectedStatus;
/// Create a copy of UnlockTestItem
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$UnlockTestItemCopyWith<UnlockTestItem> get copyWith => _$UnlockTestItemCopyWithImpl<UnlockTestItem>(this as UnlockTestItem, _$identity);

  /// Serializes this UnlockTestItem to a JSON map.
  Map<String, dynamic> toJson();


@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is UnlockTestItem&&(identical(other.id, id) || other.id == id)&&(identical(other.url, url) || other.url == url)&&(identical(other.method, method) || other.method == method)&&(identical(other.regionRegex, regionRegex) || other.regionRegex == regionRegex)&&const DeepCollectionEquality().equals(other.expectedStatus, expectedStatus));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,url,method,regionRegex,const DeepCollectionEquality().hash(expectedStatus));

@override
String toString() {
  return 'UnlockTestItem(id: $id, url: $url, method: $method, regionRegex: $regionRegex, expectedStatus: $expectedStatus)';
}
...
/// @nodoc
abstract mixin class $UnlockTestItemCopyWith<$Res>  {
  factory $UnlockTestItemCopyWith(UnlockTestItem value, $Res Function(UnlockTestItem) _then) = _$UnlockTestItemCopyWithImpl;
@useResult
$Res call({
 String id, String url, String? method,@JsonKey(name: 'region-regex') String? regionRegex,@JsonKey(name: 'expected-status') List<int>? expectedStatus
});
...
/// @nodoc
class _$UnlockTestItemCopyWithImpl<$Res>
    implements $UnlockTestItemCopyWith<$Res> {
  _$UnlockTestItemCopyWithImpl(this._self, this._then);

  final UnlockTestItem _self;
  final $Res Function(UnlockTestItem) _then;

/// Create a copy of UnlockTestItem
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? url = null,Object? method = freezed,Object? regionRegex = freezed,Object? expectedStatus = freezed,}) {
  return _then(_self.copyWith(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as String,url: null == url ? _self.url : url // ignore: cast_nullable_to_non_nullable
as String,method: freezed == method ? _self.method : method // ignore: cast_nullable_to_non_nullable
as String?,regionRegex: freezed == regionRegex ? _self.regionRegex : regionRegex // ignore: cast_nullable_to_non_nullable
...
/// Adds pattern-matching-related methods to [UnlockTestItem].
extension UnlockTestItemPatterns on UnlockTestItem {
/// A variant of `map` that fallback to returning `orElse`.
///
/// It is equivalent to doing:
/// ```dart
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _UnlockTestItem value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _UnlockTestItem() when $default != null:
return $default(_that);case _:
  return orElse();
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _UnlockTestItem value)  $default,){
final _that = this;
switch (_that) {
case _UnlockTestItem():
return $default(_that);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _UnlockTestItem value)?  $default,){
final _that = this;
switch (_that) {
case _UnlockTestItem() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String url,  String? method, @JsonKey(name: 'region-regex')  String? regionRegex, @JsonKey(name: 'expected-status')  List<int>? expectedStatus)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _UnlockTestItem() when $default != null:
return $default(_that.id,_that.url,_that.method,_that.regionRegex,_that.expectedStatus);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String url,  String? method, @JsonKey(name: 'region-regex')  String? regionRegex, @JsonKey(name: 'expected-status')  List<int>? expectedStatus)  $default,) {final _that = this;
switch (_that) {
case _UnlockTestItem():
return $default(_that.id,_that.url,_that.method,_that.regionRegex,_that.expectedStatus);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String url,  String? method, @JsonKey(name: 'region-regex')  String? regionRegex, @JsonKey(name: 'expected-status')  List<int>? expectedStatus)?  $default,) {final _that = this;
switch (_that) {
case _UnlockTestItem() when $default != null:
return $default(_that.id,_that.url,_that.method,_that.regionRegex,_that.expectedStatus);case _:
  return null;
...
class _UnlockTestItem implements UnlockTestItem {
  const _UnlockTestItem({required this.id, required this.url, this.method, @JsonKey(name: 'region-regex') this.regionRegex, @JsonKey(name: 'expected-status') final  List<int>? expectedStatus}): _expectedStatus = expectedStatus;
  factory _UnlockTestItem.fromJson(Map<String, dynamic> json) => _$UnlockTestItemFromJson(json);

@override final  String id;
@override final  String url;
@override final  String? method;
@override@JsonKey(name: 'region-regex') final  String? regionRegex;
 final  List<int>? _expectedStatus;
@override@JsonKey(name: 'expected-status') List<int>? get expectedStatus {
  final value = _expectedStatus;
  if (value == null) return null;
  if (_expectedStatus is EqualUnmodifiableListView) return _expectedStatus;
  // ignore: implicit_dynamic_type
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$UnlockTestItemCopyWith<_UnlockTestItem> get copyWith => __$UnlockTestItemCopyWithImpl<_UnlockTestItem>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$UnlockTestItemToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _UnlockTestItem&&(identical(other.id, id) || other.id == id)&&(identical(other.url, url) || other.url == url)&&(identical(other.method, method) || other.method == method)&&(identical(other.regionRegex, regionRegex) || other.regionRegex == regionRegex)&&const DeepCollectionEquality().equals(other._expectedStatus, _expectedStatus));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,url,method,regionRegex,const DeepCollectionEquality().hash(_expectedStatus));
...
/// @nodoc
abstract mixin class _$UnlockTestItemCopyWith<$Res> implements $UnlockTestItemCopyWith<$Res> {
  factory _$UnlockTestItemCopyWith(_UnlockTestItem value, $Res Function(_UnlockTestItem) _then) = __$UnlockTestItemCopyWithImpl;
@override @useResult
$Res call({
 String id, String url, String? method,@JsonKey(name: 'region-regex') String? regionRegex,@JsonKey(name: 'expected-status') List<int>? expectedStatus
});
...
/// @nodoc
class __$UnlockTestItemCopyWithImpl<$Res>
    implements _$UnlockTestItemCopyWith<$Res> {
  __$UnlockTestItemCopyWithImpl(this._self, this._then);

  final _UnlockTestItem _self;
  final $Res Function(_UnlockTestItem) _then;

/// Create a copy of UnlockTestItem
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? url = null,Object? method = freezed,Object? regionRegex = freezed,Object? expectedStatus = freezed,}) {
  return _then(_UnlockTestItem(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as String,url: null == url ? _self.url : url // ignore: cast_nullable_to_non_nullable
as String,method: freezed == method ? _self.method : method // ignore: cast_nullable_to_non_nullable
as String?,regionRegex: freezed == regionRegex ? _self.regionRegex : regionRegex // ignore: cast_nullable_to_non_nullable
as String?,expectedStatus: freezed == expectedStatus ? _self._expectedStatus : expectedStatus // ignore: cast_nullable_to_non_nullable
as List<int>?,
  ));
}
...
/// @nodoc
mixin _$UnlockTestParams {

@JsonKey(name: 'proxy-name') String get proxyName; int? get timeout; List<UnlockTestItem> get tests;
/// Create a copy of UnlockTestParams
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$UnlockTestParamsCopyWith<UnlockTestParams> get copyWith => _$UnlockTestParamsCopyWithImpl<UnlockTestParams>(this as UnlockTestParams, _$identity);

  /// Serializes this UnlockTestParams to a JSON map.
  Map<String, dynamic> toJson();


@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is UnlockTestParams&&(identical(other.proxyName, proxyName) || other.proxyName == proxyName)&&(identical(other.timeout, timeout) || other.timeout == timeout)&&const DeepCollectionEquality().equals(other.tests, tests));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,proxyName,timeout,const DeepCollectionEquality().hash(tests));

@override
String toString() {
  return 'UnlockTestParams(proxyName: $proxyName, timeout: $timeout, tests: $tests)';
}
...
/// @nodoc
abstract mixin class $UnlockTestParamsCopyWith<$Res>  {
  factory $UnlockTestParamsCopyWith(UnlockTestParams value, $Res Function(UnlockTestParams) _then) = _$UnlockTestParamsCopyWithImpl;
@useResult
$Res call({
@JsonKey(name: 'proxy-name') String proxyName, int? timeout, List<UnlockTestItem> tests
});
...
/// @nodoc
class _$UnlockTestParamsCopyWithImpl<$Res>
    implements $UnlockTestParamsCopyWith<$Res> {
  _$UnlockTestParamsCopyWithImpl(this._self, this._then);

  final UnlockTestParams _self;
  final $Res Function(UnlockTestParams) _then;

/// Create a copy of UnlockTestParams
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? proxyName = null,Object? timeout = freezed,Object? tests = null,}) {
  return _then(_self.copyWith(
proxyName: null == proxyName ? _self.proxyName : proxyName // ignore: cast_nullable_to_non_nullable
as String,timeout: freezed == timeout ? _self.timeout : timeout // ignore: cast_nullable_to_non_nullable
as int?,tests: null == tests ? _self.tests : tests // ignore: cast_nullable_to_non_nullable
as List<UnlockTestItem>,
  ));
}
...
/// Adds pattern-matching-related methods to [UnlockTestParams].
extension UnlockTestParamsPatterns on UnlockTestParams {
/// A variant of `map` that fallback to returning `orElse`.
///
/// It is equivalent to doing:
/// ```dart
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _UnlockTestParams value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _UnlockTestParams() when $default != null:
return $default(_that);case _:
  return orElse();
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _UnlockTestParams value)  $default,){
final _that = this;
switch (_that) {
case _UnlockTestParams():
return $default(_that);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _UnlockTestParams value)?  $default,){
final _that = this;
switch (_that) {
case _UnlockTestParams() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'proxy-name')  String proxyName,  int? timeout,  List<UnlockTestItem> tests)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _UnlockTestParams() when $default != null:
return $default(_that.proxyName,_that.timeout,_that.tests);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'proxy-name')  String proxyName,  int? timeout,  List<UnlockTestItem> tests)  $default,) {final _that = this;
switch (_that) {
case _UnlockTestParams():
return $default(_that.proxyName,_that.timeout,_that.tests);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'proxy-name')  String proxyName,  int? timeout,  List<UnlockTestItem> tests)?  $default,) {final _that = this;
switch (_that) {
case _UnlockTestParams() when $default != null:
return $default(_that.proxyName,_that.timeout,_that.tests);case _:
  return null;
...
class _UnlockTestParams implements UnlockTestParams {
  const _UnlockTestParams({@JsonKey(name: 'proxy-name') required this.proxyName, this.timeout, final  List<UnlockTestItem> tests = const []}): _tests = tests;
  factory _UnlockTestParams.fromJson(Map<String, dynamic> json) => _$UnlockTestParamsFromJson(json);

@override@JsonKey(name: 'proxy-name') final  String proxyName;
@override final  int? timeout;
 final  List<UnlockTestItem> _tests;
@override@JsonKey() List<UnlockTestItem> get tests {
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$UnlockTestParamsCopyWith<_UnlockTestParams> get copyWith => __$UnlockTestParamsCopyWithImpl<_UnlockTestParams>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$UnlockTestParamsToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _UnlockTestParams&&(identical(other.proxyName, proxyName) || other.proxyName == proxyName)&&(identical(other.timeout, timeout) || other.timeout == timeout)&&const DeepCollectionEquality().equals(other._tests, _tests));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,proxyName,timeout,const DeepCollectionEquality().hash(_tests));
...
/// @nodoc
abstract mixin class _$UnlockTestParamsCopyWith<$Res> implements $UnlockTestParamsCopyWith<$Res> {
  factory _$UnlockTestParamsCopyWith(_UnlockTestParams value, $Res Function(_UnlockTestParams) _then) = __$UnlockTestParamsCopyWithImpl;
@override @useResult
$Res call({
@JsonKey(name: 'proxy-name') String proxyName, int? timeout, List<UnlockTestItem> tests
});
...
/// @nodoc
class __$UnlockTestParamsCopyWithImpl<$Res>
    implements _$UnlockTestParamsCopyWith<$Res> {
  __$UnlockTestParamsCopyWithImpl(this._self, this._then);

  final _UnlockTestParams _self;
  final $Res Function(_UnlockTestParams) _then;

/// Create a copy of UnlockTestParams
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? proxyName = null,Object? timeout = freezed,Object? tests = null,}) {
  return _then(_UnlockTestParams(
proxyName: null == proxyName ? _self.proxyName : proxyName // ignore: cast_nullable_to_non_nullable
as String,timeout: freezed == timeout ? _self.timeout : timeout // ignore: cast_nullable_to_non_nullable
as int?,tests: null == tests ? _self._tests : tests // ignore: cast_nullable_to_non_nullable
as List<UnlockTestItem>,
  ));
}
...
/// @nodoc
mixin _$UnlockTestResultItem {

 String get id; int get status; int get latency; String get region; bool get unlocked; String get error;
/// Create a copy of UnlockTestResultItem
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$UnlockTestResultItemCopyWith<UnlockTestResultItem> get copyWith => _$UnlockTestResultItemCopyWithImpl<UnlockTestResultItem>(this as UnlockTestResultItem, _$identity);

  /// Serializes this UnlockTestResultItem to a JSON map.
  Map<String, dynamic> toJson();


@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is UnlockTestResultItem&&(identical(other.id, id) || other.id == id)&&(identical(other.status, status) || other.status == status)&&(identical(other.latency, latency) || other.latency == latency)&&(identical(other.region, region) || other.region == region)&&(identical(other.unlocked, unlocked) || other.unlocked == unlocked)&&(identical(other.error, error) || other.error == error));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,status,latency,region,unlocked,error);

@override
String toString() {
  return 'UnlockTestResultItem(id: $id, status: $status, latency: $latency, region: $region, unlocked: $unlocked, error: $error)';
}
...
/// @nodoc
abstract mixin class $UnlockTestResultItemCopyWith<$Res>  {
  factory $UnlockTestResultItemCopyWith(UnlockTestResultItem value, $Res Function(UnlockTestResultItem) _then) = _$UnlockTestResultItemCopyWithImpl;
@useResult
$Res call({
 String id, int status, int latency, String region, bool unlocked, String error
});
...
/// @nodoc
class _$UnlockTestResultItemCopyWithImpl<$Res>
    implements $UnlockTestResultItemCopyWith<$Res> {
  _$UnlockTestResultItemCopyWithImpl(this._self, this._then);

  final UnlockTestResultItem _self;
  final $Res Function(UnlockTestResultItem) _then;

/// Create a copy of UnlockTestResultItem
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? status = null,Object? latency = null,Object? region = null,Object? unlocked = null,Object? error = null,}) {
  return _then(_self.copyWith(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
...
/// Adds pattern-matching-related methods to [UnlockTestResultItem].
extension UnlockTestResultItemPatterns on UnlockTestResultItem {
/// A variant of `map` that fallback to returning `orElse`.
///
/// It is equivalent to doing:
/// ```dart
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _UnlockTestResultItem value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _UnlockTestResultItem() when $default != null:
return $default(_that);case _:
  return orElse();
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _UnlockTestResultItem value)  $default,){
final _that = this;
switch (_that) {
case _UnlockTestResultItem():
return $default(_that);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _UnlockTestResultItem value)?  $default,){
final _that = this;
switch (_that) {
case _UnlockTestResultItem() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  int status,  int latency,  String region,  bool unlocked,  String error)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _UnlockTestResultItem() when $default != null:
return $default(_that.id,_that.status,_that.latency,_that.region,_that.unlocked,_that.error);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  int status,  int latency,  String region,  bool unlocked,  String error)  $default,) {final _that = this;
switch (_that) {
case _UnlockTestResultItem():
return $default(_that.id,_that.status,_that.latency,_that.region,_that.unlocked,_that.error);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  int status,  int latency,  String region,  bool unlocked,  String error)?  $default,) {final _that = this;
switch (_that) {
case _UnlockTestResultItem() when $default != null:
return $default(_that.id,_that.status,_that.latency,_that.region,_that.unlocked,_that.error);case _:
  return null;
...
class _UnlockTestResultItem implements UnlockTestResultItem {
  const _UnlockTestResultItem({this.id = '', this.status = 0, this.latency = 0, this.region = '', this.unlocked = false, this.error = ''});
  factory _UnlockTestResultItem.fromJson(Map<String, dynamic> json) => _$UnlockTestResultItemFromJson(json);

@override@JsonKey() final  String id;
@override@JsonKey() final  int status;
@override@JsonKey() final  int latency;
@override@JsonKey() final  String region;
@override@JsonKey() final  bool unlocked;
@override@JsonKey() final  String error;
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$UnlockTestResultItemCopyWith<_UnlockTestResultItem> get copyWith => __$UnlockTestResultItemCopyWithImpl<_UnlockTestResultItem>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$UnlockTestResultItemToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _UnlockTestResultItem&&(identical(other.id, id) || other.id == id)&&(identical(other.status, status) || other.status == status)&&(identical(other.latency, latency) || other.latency == latency)&&(identical(other.region, region) || other.region == region)&&(identical(other.unlocked, unlocked) || other.unlocked == unlocked)&&(identical(other.error, error) || other.error == error));
}
...
/// @nodoc
abstract mixin class _$UnlockTestResultItemCopyWith<$Res> implements $UnlockTestResultItemCopyWith<$Res> {
  factory _$UnlockTestResultItemCopyWith(_UnlockTestResultItem value, $Res Function(_UnlockTestResultItem) _then) = __$UnlockTestResultItemCopyWithImpl;
@override @useResult
$Res call({
 String id, int status, int latency, String region, bool unlocked, String error
});
...
/// @nodoc
class __$UnlockTestResultItemCopyWithImpl<$Res>
    implements _$UnlockTestResultItemCopyWith<$Res> {
  __$UnlockTestResultItemCopyWithImpl(this._self, this._then);

  final _UnlockTestResultItem _self;
  final $Res Function(_UnlockTestResultItem) _then;

/// Create a copy of UnlockTestResultItem
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? status = null,Object? latency = null,Object? region = null,Object? unlocked = null,Object? error = null,}) {
  return _then(_UnlockTestResultItem(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as String,status: null == status ? _self.status : status // ignore: cast_nullable_to_non_nullable
as int,latency: null == latency ? _self.latency : latency // ignore: cast_nullable_to_non_nullable
as int,region: null == region ? _self.region : region // ignore: cast_nullable_to_non_nullable
...
/// @nodoc
mixin _$UnlockTestResult {

 String get name; List<UnlockTestResultItem> get results; String get error;
/// Create a copy of UnlockTestResult
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$UnlockTestResultCopyWith<UnlockTestResult> get copyWith => _$UnlockTestResultCopyWithImpl<UnlockTestResult>(this as UnlockTestResult, _$identity);

  /// Serializes this UnlockTestResult to a JSON map.
  Map<String, dynamic> toJson();


@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is UnlockTestResult&&(identical(other.name, name) || other.name == name)&&const DeepCollectionEquality().equals(other.results, results)&&(identical(other.error, error) || other.error == error));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,name,const DeepCollectionEquality().hash(results),error);

@override
String toString() {
  return 'UnlockTestResult(name: $name, results: $results, error: $error)';
}
...
/// @nodoc
abstract mixin class $UnlockTestResultCopyWith<$Res>  {
  factory $UnlockTestResultCopyWith(UnlockTestResult value, $Res Function(UnlockTestResult) _then) = _$UnlockTestResultCopyWithImpl;
@useResult
$Res call({
 String name, List<UnlockTestResultItem> results, String error
});
...
/// @nodoc
class _$UnlockTestResultCopyWithImpl<$Res>
    implements $UnlockTestResultCopyWith<$Res> {
  _$UnlockTestResultCopyWithImpl(this._self, this._then);

  final UnlockTestResult _self;
  final $Res Function(UnlockTestResult) _then;

/// Create a copy of UnlockTestResult
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? name = null,Object? results = null,Object? error = null,}) {
  return _then(_self.copyWith(
name: null == name ? _self.name : name // ignore: cast_nullable_to_non_nullable
as String,results: null == results ? _self.results : results // ignore: cast_nullable_to_non_nullable
as List<UnlockTestResultItem>,error: null == error ? _self.error : error // ignore: cast_nullable_to_non_nullable
as String,
  ));
}
...
/// Adds pattern-matching-related methods to [UnlockTestResult].
extension UnlockTestResultPatterns on UnlockTestResult {
/// A variant of `map` that fallback to returning `orElse`.
///
/// It is equivalent to doing:
/// ```dart
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _UnlockTestResult value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _UnlockTestResult() when $default != null:
return $default(_that);case _:
  return orElse();
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _UnlockTestResult value)  $default,){
final _that = this;
switch (_that) {
case _UnlockTestResult():
return $default(_that);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _UnlockTestResult value)?  $default,){
final _that = this;
switch (_that) {
case _UnlockTestResult() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String name,  List<UnlockTestResultItem> results,  String error)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _UnlockTestResult() when $default != null:
return $default(_that.name,_that.results,_that.error);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String name,  List<UnlockTestResultItem> results,  String error)  $default,) {final _that = this;
switch (_that) {
case _UnlockTestResult():
return $default(_that.name,_that.results,_that.error);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String name,  List<UnlockTestResultItem> results,  String error)?  $default,) {final _that = this;
switch (_that) {
case _UnlockTestResult() when $default != null:
return $default(_that.name,_that.results,_that.error);case _:
  return null;
...
class _UnlockTestResult implements UnlockTestResult {
  const _UnlockTestResult({this.name = '', final  List<UnlockTestResultItem> results = const [], this.error = ''}): _results = results;
  factory _UnlockTestResult.fromJson(Map<String, dynamic> json) => _$UnlockTestResultFromJson(json);

@override@JsonKey() final  String name;
 final  List<UnlockTestResultItem> _results;
@override@JsonKey() List<UnlockTestResultItem> get results {
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$UnlockTestResultCopyWith<_UnlockTestResult> get copyWith => __$UnlockTestResultCopyWithImpl<_UnlockTestResult>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$UnlockTestResultToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _UnlockTestResult&&(identical(other.name, name) || other.name == name)&&const DeepCollectionEquality().equals(other._results, _results)&&(identical(other.error, error) || other.error == error));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,name,const DeepCollectionEquality().hash(_results),error);
...
/// @nodoc
abstract mixin class _$UnlockTestResultCopyWith<$Res> implements $UnlockTestResultCopyWith<$Res> {
  factory _$UnlockTestResultCopyWith(_UnlockTestResult value, $Res Function(_UnlockTestResult) _then) = __$UnlockTestResultCopyWithImpl;
@override @useResult
$Res call({
 String name, List<UnlockTestResultItem> results, String error
});
...
/// @nodoc
class __$UnlockTestResultCopyWithImpl<$Res>
    implements _$UnlockTestResultCopyWith<$Res> {
  __$UnlockTestResultCopyWithImpl(this._self, this._then);

  final _UnlockTestResult _self;
  final $Res Function(_UnlockTestResult) _then;

/// Create a copy of UnlockTestResult
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? name = null,Object? results = null,Object? error = null,}) {
  return _then(_UnlockTestResult(
name: null == name ? _self.name : name // ignore: cast_nullable_to_non_nullable
