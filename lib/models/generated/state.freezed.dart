...
mixin _$SharedState {
 ...
 SetupParams? get setupParams; VpnOptions? get vpnOptions; String get stopTip; String get startTip; String get currentProfileName; String get stopText; String get suspendedText; bool get onlyStatisticsProxy; bool get crashlytics; List<String> get suspendOnWifiSsids;
...
@useResult
$Res call({
 SetupParams? setupParams, VpnOptions? vpnOptions, String stopTip, String startTip, String currentProfileName, String stopText, String suspendedText, bool onlyStatisticsProxy, bool crashlytics, List<String> suspendOnWifiSsids
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( SetupParams? setupParams,  VpnOptions? vpnOptions,  String stopTip,  String startTip,  String currentProfileName,  String stopText,  String suspendedText,  bool onlyStatisticsProxy,  bool crashlytics,  List<String> suspendOnWifiSsids)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SharedState() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( SetupParams? setupParams,  VpnOptions? vpnOptions,  String stopTip,  String startTip,  String currentProfileName,  String stopText,  String suspendedText,  bool onlyStatisticsProxy,  bool crashlytics,  List<String> suspendOnWifiSsids)  $default,) {final _that = this;
switch (_that) {
case _SharedState():
return $default(_that.setupParams,_that.vpnOptions,_that.stopTip,_that.startTip,_that.currentProfileName,_that.stopText,_that.suspendedText,_that.onlyStatisticsProxy,_that.crashlytics,_that.suspendOnWifiSsids);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( SetupParams? setupParams,  VpnOptions? vpnOptions,  String stopTip,  String startTip,  String currentProfileName,  String stopText,  String suspendedText,  bool onlyStatisticsProxy,  bool crashlytics,  List<String> suspendOnWifiSsids)?  $default,) {final _that = this;
switch (_that) {
case _SharedState() when $default != null:
return $default(_that.setupParams,_that.vpnOptions,_that.stopTip,_that.startTip,_that.currentProfileName,_that.stopText,_that.suspendedText,_that.onlyStatisticsProxy,_that.crashlytics,_that.suspendOnWifiSsids);case _:
  return null;
...
class _SharedState implements SharedState {
  const _SharedState({this.setupParams, this.vpnOptions, required this.stopTip, required this.startTip, required this.currentProfileName, required this.stopText, this.suspendedText = 'Suspended...', required this.onlyStatisticsProxy, required this.crashlytics, final  List<String> suspendOnWifiSsids = const []}): _suspendOnWifiSsids = suspendOnWifiSsids;
...
@override final  String suspendedText;
